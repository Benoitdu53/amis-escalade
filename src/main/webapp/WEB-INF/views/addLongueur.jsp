                ...
                <form:form id="formulaireLongueur" method="post" modelAttribute="longueur">
                    <table>
                        <div class="nbrePoints">
                            <tr>
                                <td><form:label id="nbrePoints"
                                                path="nbrePoints">Indiquer le nombre de points</form:label></td>
                                <td><form:input path="nbrePoints" required="required" type="number" min="0"
                                                max="100"/></td>
                            </tr>
                        </div>
                        ...
                        <div class="cotation">
                            <tr>
                                <td>
                                    <form:label id="cotation"
                                                path="cotation">Cotation de la longueur</form:label>
